...
if __name__ == "__main__":
    # Example dataframe
    df = pd.read_csv("../extracted_data/boston.csv")
    df_numeric = df.select_dtypes(include=[np.number]).dropna().drop(columns=['CHAS', 'RAD'])
    ...
    outlier_detector.visualize_outliers(df_cleaned, features=["CRIM", "ZN", "MEDV"])
    # pass
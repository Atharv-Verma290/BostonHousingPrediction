...
class CategoricalVsNumericalAnalysis(BivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature1: str, feature2: str):
        """
        Plots the relationship between a categorical feature and a numerical feature using box plots.
        ...
        Returns:
        None: Displays box plots showing the relationship between the two features.
        """
        plt.figure(figsize=(10, 6))
...
class CategoricalVsCategoricalAnalysis(BivariateAnalysisStrategy):
    def analyze(self, df: pd.DataFrame, feature1: str, feature2: str):
        """
        Plots the relationship between two categorical features using stacked bar chart.
        ...
        Returns:
        None: Displays stacked bar chart showing the relationship between the two features.
        """
        cont_table = pd.crosstab(df[feature1], df[feature2])
        cont_table.plot(kind="bar", stacked=True, figsize=(10, 6))
        plt.title(f'{feature1} vs {feature2}')
        plt.xlabel(feature1)
        plt.ylabel(feature2)
